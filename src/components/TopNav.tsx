    ...
    <header className="sticky top-0 z-40 glass-card-strong border-b border-border/50">
      <div className="container flex h-14 items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
          <Link to="/listings" className="hover:text-foreground transition-colors">{t("nav.explore")}</Link>
          <Link to="/payments" className="hover:text-foreground transition-colors">{t("nav.payments")}</Link>
